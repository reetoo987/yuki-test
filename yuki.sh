...
echo ""
echo "                         _od88888888888bo.
echo "                        d=====88888888=8888b.
echo "                      .d==============8888888b.
echo "                     d888888==8===8888888######b
echo "                    d8888888888888888888########b
echo "                   d88888#####888888##8##########
echo "                   88888#########################b
echo "                   Y88############################
echo "                    Y8#####"Y###`###"'__Y#########
echo "                     Y####b\ /"" `" ,/ .\"#######P
...
echo "   ║    Coded by : l7nc7 | Weebu of anime    ║"
echo "    ║                 Tested on : Kali Linux                 ║"
echo "     ║     More Info :              rule34.xyz              ║"              
echo "      ╚════════════════════════════════════════════════════╝"
